...
for (let i = 0; i < 5; i++) s.postMessage(room, "bob", BODY, "text", null, null, null);
...
s.postMessage(room, "bob", "y".repeat(20_000), "text", null, null, null); // seq 6
...
s.postMessage(room, "bob", "crossing-1", "text", null, null, null); // seq 7
s.postMessage(room, "bob", "crossing-2", "text", null, null, null); // seq 8
const posted = s.postMessage(room, "alice", "my blind post", "text", null, null, null); // seq 9
...
const caughtUp = s.catchUp(room, "alice", 50, undefined, 100000);
check(caughtUp.messages.length === 2, "crossed messages still arrive via catch_up (not marked read)");
const cleanPost = s.postMessage(room, "alice", "informed post", "text", null, null, null); // seq 10
...
// --- boundByBytes: preview_chars > max_bytes must still respect the budget --
{
  ...
  v.joinRoom(r, "a", {});
  v.joinRoom(r, "b", {});
  v.postMessage(r, "b", "z".repeat(300_000), "text", null, null, null);
  ...
  v.postMessage(r, "b", "\u0001".repeat(30_000), "text", null, null, null);
...
// --- get_thread: one budget across focal + parent + replies -----------------
{
  ...
  mkAgent(v, "a");
  v.joinRoom(r, "a", {});
  v.postMessage(r, "a", "R".repeat(150_000), "text", null, null, null); // seq 1: root
  v.postMessage(r, "a", "P".repeat(150_000), "text", null, 1, null); // seq 2: focal, replies to 1
  v.postMessage(r, "a", "small reply", "text", null, 2, null); // seq 3
...
// --- get_message: final page reports truncated:false ------------------------
{
  ...
  mkAgent(v, "a");
  v.joinRoom(r, "a", {});
  v.postMessage(r, "a", "abcdef", "text", null, null, null);
